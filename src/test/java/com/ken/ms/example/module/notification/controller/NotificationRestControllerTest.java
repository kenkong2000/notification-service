package com.ken.ms.example.module.notification.controller;
...
import com.ken.ms.example.module.notification.security.SpringSecurityConfig;
...
public class NotificationRestControllerTest {
	...
	private SpringSecurityConfig config;
	 ...
	 public void  whenCallWith_multiple_toaddress_thenSuccess() {
		 ...
		 headers.setContentType(MediaType.APPLICATION_JSON);
		 String requestJson ="[{\"to\":[\"ken@test.com\", \"test@testapp.com\"],\"subject\":\"my subject\", \"body\":\"hello world!\" }]";
		 HttpEntity<String> entity = new HttpEntity<String>(requestJson, headers);
		 ResponseEntity<String> responseEntity = restTemplate
		            .exchange("/api/notification/email", HttpMethod.POST, entity, String.class);		
		 assertEquals(HttpStatus.NO_CONTENT, responseEntity.getStatusCode());
	 ...
	 public void  whenCallWith_invalid_NotificationDto_thenSuccess() {
		 ...
		 headers.setContentType(MediaType.APPLICATION_JSON);
		 // to1
		 String requestJson ="[{\"to1\":[\"ken@test.com\", \"test@testapp.com\"],\"subject\":\"my subject\", \"body\":\"hello world!\" }]";
		 HttpEntity<String> entity = new HttpEntity<String>(requestJson, headers);
		 ResponseEntity<String> responseEntity = restTemplate
		            .exchange("/api/notification/email", HttpMethod.POST, entity, String.class);		
		 assertEquals(HttpStatus.BAD_REQUEST, responseEntity.getStatusCode());
